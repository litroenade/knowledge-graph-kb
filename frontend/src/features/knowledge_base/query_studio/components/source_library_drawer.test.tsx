...
describe('SourceLibraryDrawer', () => {
  ...
  it('separates latest import stats from current snapshot stats', () => {
    ...
    expect(screen.getByText('当前快照统计')).toBeInTheDocument();
    expect(screen.getByText('最新导入统计 · 段落 136 / 实体 458 / 关系 571')).toBeInTheDocument();
